defmodule Guesty.RPCReceiver do
  @moduledoc false
  ...
  def handle_message(:default, message, context) do
    ...
    error ->
      log_error(error, message.data, __STACKTRACE__)
      message
  end
  ...
  defp log_error(error, message, stacktrace) do
    Logger.error(error: error, message: message, stacktrace: stacktrace)
  end
